...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2 class="left-justify">Sign In!</h2>
            <div class="row">
                ...
                <div class="col-md-12">
                    <asp:Button ID="btnLogIn" CssClass="btn btn-primary" runat="server" Text="Log In"/>
                ...
                <div class ="col-md-12">
                    <br />
                    <asp:Button ID="btnSignUp" runat="server" Text="Sign Up" CausesValidation="False" CssClass="btn btn-success"/>
                </div>
